package umn.ac.id.week13_27299;
...
import umn.ac.id.week13_27299.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        daftarMarkerDanShape.add(new MarkerAndShape("Marker",
                "Universitas Multimedia Nusantara", 0.0, lokalTitiks));
        daftarMarkerDanShape.add(new MarkerAndShape("Circle",
        ...
        daftarMarkerDanShape.add(new MarkerAndShape("PolyLine",
        ...
        daftarMarkerDanShape.add(new MarkerAndShape("Polygon",
    ...
    public void onActivityResult(int reqCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && reqCode == REQUEST_TAMBAH) {
            ...
            MarkerAndShape mds = new MarkerAndShape(jenis, keterangan,radius, mTitiks);
