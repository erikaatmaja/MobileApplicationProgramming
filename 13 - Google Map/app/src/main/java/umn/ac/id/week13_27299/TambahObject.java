...
import umn.ac.id.week13_27299.databinding.ActivityTambahObjectBinding;
                ...
                switch(pilihan){
                    case 0:
                        ...
                        if(mMap != null){
                            mMap.clear();
                            mMap.addMarker(new
                                    MarkerOptions().position(titiks.get(0)).title(etKeterangan.getText().toString()));
                    ...
                    case 1:
                        ...
                        if(mMap != null){
                            ...
                            if(rad.length() > 0
                                ...
                                mMap.addCircle(new CircleOptions().radius(radius).center(titiks.get(0)).strokeColor(Color.YELLOW)
                    ...
                    case 3:
                        ...
                        if(titiks.size() == 1) {
                            ...
                            PolygonOptions pg = new PolygonOptions().strokeColor(Color.BLUE).strokeWidth(10.0f)
